...
const About = () => {
  ...
  return (
    <main
      className={`min-h-screen flex justify-center p-6 ${darkMode ? "bg-gray-900 text-gray-200" : "bg-gray-100 text-gray-900"}`}
      aria-live="polite"
    >
      <section className="max-w-3xl mx-auto p-6 font-poppins">
        <h1
          className={`text-3xl font-bold text-center mb-8 ${darkMode ? "text-teal-500" : "text-teal-700"}`}
        >
          About Me
        </h1>
        <div
          className={`rounded-lg shadow-lg p-6 ${darkMode ? "bg-gray-800 text-gray-200" : "bg-gray-100 text-gray-900"}`}
        >
